...
//import br.com.crescer.aula1.tema.StringUtils;
//import br.com.crescer.aula1.tema.ManipuladorDeString;
...
public class Chat {
  ...
  //  private static final StringUtils STRING_UTILS = new ManipuladorDeString();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@mateus.silva"};
        }
