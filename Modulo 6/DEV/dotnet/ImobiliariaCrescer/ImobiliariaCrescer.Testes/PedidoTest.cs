...
namespace ImobiliariaCrescer.Testes
{
    ...
    public class PedidoTest
    {
        ...
        public void pedidoCom100DiasDeAtraso()
        {
            ...
            pedido.SetDataDeEntrega();
            pedido.AplicaMulta();
            Assert.AreEqual(1100, Math.Truncate((decimal)pedido.Multa));
        }

        [TestMethod]
        public void pedidoCom400DiasDeAtraso()
        {
            int id = 1;
            string nome = "Mateus";
            string cpf = "02701870071";
            ...
            itens.Add(item1);
            itens.Add(item2);
            DateTime entrega = DateTime.Now.AddDays(-400);
            ...
            pedido.SetDataDeEntrega();
            pedido.AplicaMulta();
            Assert.AreEqual(44000, Math.Truncate((decimal)pedido.Multa));
        }
